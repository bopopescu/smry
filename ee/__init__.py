...
def ServiceAccountCredentials(email, key_file=None, key_data=None):
  ...
  Expect key_file string to include a full path to the key file.
  """
  ...
  if key_file:
    ...
    try:
      ...
      logmsg = "# 1 ServiceAccountCredentials( )|"
      logmsg += "Failure accessing key file: %s"
      smrylogger.warning("logmsg", key_file)
