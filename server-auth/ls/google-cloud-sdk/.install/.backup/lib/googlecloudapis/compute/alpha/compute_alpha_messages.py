...
class InstanceGroupManagerActionsSummary(_messages.Message):
  ...
  Fields:
    ...
    restarting: A integer attribute.
  """
...
class ManagedInstance(_messages.Message):
  ...
  Fields:
    ...
    deprecatedIncarnationId: Deprecated: The unique identifier for this
      resource (empty when instance does not exist).
  ...
  deprecatedIncarnationId = _messages.IntegerField(2)
  id = _messages.IntegerField(3, variant=_messages.Variant.UINT64)
