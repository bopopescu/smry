...
from googlecloudapis.appengine.v1beta4 import appengine_v1beta4_messages as messages
...
class AppengineV1beta4(base_api.BaseApiClient):
  ...
  def __init__(self, url='', credentials=None,
    ...
    url = url or u'https://appengine.googleapis.com/v1beta4/'
    ...
    self.apps_emailSenders = self.AppsEmailSendersService(self)
  ...
  class AppsEmailSendersService(base_api.BaseApiService):
    """Service class for the apps_emailSenders resource."""

    _NAME = u'apps_emailSenders'

    def __init__(self, client):
      super(AppengineV1beta4.AppsEmailSendersService, self).__init__(client)
      self._method_configs = {
          'Create': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.emailSenders.create',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[],
              relative_path=u'{+name}/emailSenders',
              request_field=u'emailSender',
              request_type_name=u'AppengineAppsEmailSendersCreateRequest',
              response_type_name=u'EmailSender',
              supports_download=False,
          ),
          'Delete': base_api.ApiMethodInfo(
              http_method=u'DELETE',
              method_id=u'appengine.apps.emailSenders.delete',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[],
              relative_path=u'{+name}',
              request_field='',
              request_type_name=u'AppengineAppsEmailSendersDeleteRequest',
              response_type_name=u'Empty',
              supports_download=False,
          ),
          'List': base_api.ApiMethodInfo(
              http_method=u'GET',
              method_id=u'appengine.apps.emailSenders.list',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[u'pageSize', u'pageToken'],
              relative_path=u'{+name}/emailSenders',
              request_field='',
              request_type_name=u'AppengineAppsEmailSendersListRequest',
              response_type_name=u'ListEmailSendersResponse',
              supports_download=False,
          ),
          }
    ...
    def Create(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsEmailSendersCreateRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (EmailSender) The response message.
      """
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsEmailSendersDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    def List(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsEmailSendersListRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ListEmailSendersResponse) The response message.
      """
  ...
  class AppsModulesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'GetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.modules.getIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'{+resource}:getIamPolicy',
              request_field=u'getIamPolicyRequest',
              request_type_name=u'AppengineAppsModulesGetIamPolicyRequest',
          ...
          'SetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.modules.setIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'{+resource}:setIamPolicy',
              request_field=u'setIamPolicyRequest',
              request_type_name=u'AppengineAppsModulesSetIamPolicyRequest',
              response_type_name=u'Policy',
              supports_download=False,
          ),
          }
    ...
    def GetIamPolicy(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsModulesGetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    def SetIamPolicy(self, request, global_params=None):
      """Sets the IAM policy of the specified module for the specified user. See google/iam/v1/iam_policy.proto for details.

      Args:
        request: (AppengineAppsModulesSetIamPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Policy) The response message.
      """
  ...
  class AppsOperationsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          'Cancel': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.operations.cancel',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[],
              relative_path=u'{+name}:cancel',
              request_field=u'cancelOperationRequest',
              request_type_name=u'AppengineAppsOperationsCancelRequest',
              response_type_name=u'Empty',
              supports_download=False,
          ),
          'Delete': base_api.ApiMethodInfo(
              http_method=u'DELETE',
              method_id=u'appengine.apps.operations.delete',
              ordered_params=[u'name'],
              path_params=[u'name'],
              query_params=[],
              relative_path=u'{+name}',
              request_field='',
              request_type_name=u'AppengineAppsOperationsDeleteRequest',
              response_type_name=u'Empty',
              supports_download=False,
          ),
          'Get': base_api.ApiMethodInfo(
          ...
          'List': base_api.ApiMethodInfo(
              ...
              relative_path=u'{+name}/operations',
              request_field='',
    ...
    def Cancel(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsOperationsCancelRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
    ...
    def Delete(self, request, global_params=None):
      ...
      Args:
        request: (AppengineAppsOperationsDeleteRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
  ...
  class AppsService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'GetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.getIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'{+resource}:getIamPolicy',
              request_field='',
              request_type_name=u'AppengineAppsGetIamPolicyRequest',
              response_type_name=u'Policy',
              supports_download=False,
          ),
          'Patch': base_api.ApiMethodInfo(
          ...
          'SetIamPolicy': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'appengine.apps.setIamPolicy',
              ordered_params=[u'resource'],
              path_params=[u'resource'],
              query_params=[],
              relative_path=u'{+resource}:setIamPolicy',
              request_field=u'setIamPolicyRequest',
              request_type_name=u'AppengineAppsSetIamPolicyRequest',
              response_type_name=u'Policy',
              supports_download=False,
          ),
          }
