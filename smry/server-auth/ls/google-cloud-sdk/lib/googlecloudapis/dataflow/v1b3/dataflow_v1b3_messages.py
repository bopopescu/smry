...
class ComputationTopology(_messages.Message):
  ...
  Fields:
    ...
    systemStageName: A string attribute.
    userStageName: A string attribute.
  """
  ...
  systemStageName = _messages.StringField(5)
  userStageName = _messages.StringField(6)
...
class TopologyConfig(_messages.Message):
  ...
  Messages:
    UserStageToComputationNameMapValue: A UserStageToComputationNameMapValue
      object.

  Fields:
    computations: A ComputationTopology attribute.
    dataDiskAssignments: A DataDiskAssignment attribute.
    userStageToComputationNameMap: A UserStageToComputationNameMapValue
      attribute.
  """

  @encoding.MapUnrecognizedFields('additionalProperties')
  class UserStageToComputationNameMapValue(_messages.Message):
    """A UserStageToComputationNameMapValue object.
