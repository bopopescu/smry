...
class RegionImages:
    ...
    def rgn_smry_images(self, region, year):
        ...
        """
        # 1
#         smrylogger.debug("1 rgn_smry_images( )|region: %s, year: %s", region, year)
    ...
    def map_filter(self, region, year, feature, image_size):
        ...
        # logging 1
#         smrylogger.debug("1 map_filter( )|region: %s, year: %s", region, year)
...
#             smrylogger.warning("6 map_filter( )|Chart objects not found")
    ...
    def chart_filter(self, region, year, feature, image_size, chart_type):
        ...
        # logging 1
#         smrylogger.debug("1 chart_filter( )|region: %s, year: %s", region, year)
#         smrylogger.debug("1 chart_filter( )|feature: %s", feature)
#         smrylogger.debug("1 chart_filter( )|image_size: %s, chart_type: %s", image_size, chart_type)
...
#         smrylogger.debug(logmsg, feature, len(chart_objects))
        ...
        # logging 3
#         logmsg = "3 chart_filter( )|chart_type__contains: %s, chart_objects: %s"
...
#             smrylogger.warning("7 chart_filter( )|Chart objects not found")
        ...
        # smrylogger.debug("\tFile Name: %s", filename)
